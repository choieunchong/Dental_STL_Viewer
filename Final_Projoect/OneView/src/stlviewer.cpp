...
void STLViewer::AdvancingFrontMethod(TriMesh& triMesh)
{
    ...
    //}
        mTriMesh = triMesh;
        mMeshToPoly = convertToPolyData(mTriMesh);
        vtkPolyDataMapper::SafeDownCast(mActor->GetMapper())->SetInputData(mMeshToPoly);
}
