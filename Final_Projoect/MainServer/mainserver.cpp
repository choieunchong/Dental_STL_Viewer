...
//              QDataStream out(&dataArray, QIODevice::WriteOnly);
                ...
                byteArray += patientName.toUtf8() + "/c/" +\
                        patientBirth.toUtf8() + "/c/" + QString::number(patientChartNumber) + "/c/" + \
            ...
            byteArray += "/p/" + QString::number(server) + "/p/" + QString::number(Send_Info) + "/p/" +  \
                    "num/" + QString::number(patientModel->rowCount());
